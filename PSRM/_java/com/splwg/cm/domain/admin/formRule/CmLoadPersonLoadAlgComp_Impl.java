...
@AlgorithmComponent ()
 */
public class CmLoadPersonLoadAlgComp_Impl extends CmLoadPersonLoadAlgComp_Gen
...
Logger logger = LoggerFactory.getLogger(CmLoadPersonLoadAlgComp_Impl.class);
    ...
    public void invoke() {
        ...
        logger.info("Executing Person Load Algorithm *********123456789");
        ...
        Person person = new Person_Id(
                (String) formBoInstance.getFieldAndMDForPath("personInformation/personId/asCurrent").getValue())
                        .getEntity();
        ...
        if (notNull(relatedTransactionBOId)) {
            ...
            // Read Person
            // TODO insert here the read bo line. Use the
            // BusinessObjectDispatcher class.
            ...
            String firstName = (String) personBoInstance
                    .getFieldAndMDForPath("personName[isPrimaryName = 'true' and nameType = 'PRIM']/firstName")
                    .getValue();
            String lastName = (String) personBoInstance
                    .getFieldAndMDForPath("personName[isPrimaryName = 'true' and nameType = 'PRIM']/lastName").getValue();
            String idType = (String) personBoInstance.getFieldAndMDForPath("personIds[isPrimaryId = 'true']/idType")
                    .getValue();
            String idValue = (String) personBoInstance
                    .getFieldAndMDForPath("personIds[isPrimaryId = 'true']/personIdNumber").getValue();
            ...
            formBoInstance.setXMLFieldStringFromPath("identification/idType/asCurrent", idType);
