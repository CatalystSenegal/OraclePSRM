...
*/	public static final String PROFESSION = "Profession";
	...
	public HashMap<String, String> getLookUpConstanst() {
		//lookUpConstant.put(TYPE_D_EMPLOYEUR, "CmEmployerType");
		//lookUpConstant.put(TYPE_D_EST, "CmEstablishmentType");
		...
		//lookUpConstant.put(NATIONALITE, "CmNationality");
		//lookUpConstant.put(PAYS_DE_NAISSANCE, "");
		//lookUpConstant.put(TYPE_PIECE_IDENTITE, "");
